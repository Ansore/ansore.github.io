    ...
    function(module, exports, __webpack_require__) {
      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            ...
            var minSrc = 'https://ansore-album.oss-cn-beijing.aliyuncs.com/blog/min_photos/' + data.link[i];
            var src = 'https://ansore-album.oss-cn-beijing.aliyuncs.com/blog/photos/' + data.link[i];
      ...
      function loadData(success) {
        if (!searchData) {
          ...
          // TODO data文件存在oos上不成功 有跨域问题
          // xhr.open('GET', 'http://ansore-album.oss-cn-beijing.aliyuncs.com/blog/data.json', true);
          // xhr.setRequestHeader("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8");
          // xhr.setRequestHeader("Accept-Encoding", "gzip, deflate");
          // xhr.setRequestHeader("Accept-Language", "en-US,en;q=0.9,zh-CN;q=0.8,zh;q=0.7");
          // xhr.setRequestHeader("User-Agent", "Mozilla/5.0 (Linux; Android 5.0; SM-G900P Build/LRX21T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Mobile Safari/537.36");
          // xhr.setRequestHeader("Cache-Control", "max-age=0");
          // xhr.setRequestHeader("Connection", "keep-alive");
          // xhr.setRequestHeader("Host", "ansore-album.oss-cn-beijing.aliyuncs.com");
          // xhr.setRequestHeader("Upgrade-Insecure-Requests", "1");
          // xhr.setRequestHeader("If-None-Match", "\"0CF4375356C34CC15FD15F3925D531CD\"");
